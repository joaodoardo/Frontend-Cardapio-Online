...
const styles = {
  container: { width: '100%', maxWidth: '1280px', margin: '0 auto', padding: '0 1rem', boxSizing: 'border-box', color: 'black'},
  ...
  label: { fontSize: '0.875rem', fontWeight: 500, color: '#000000ff', display: 'block', marginBottom: '0.5rem' },
  modalOverlay: { color: 'black', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', zIndex: 50, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '1rem'},
